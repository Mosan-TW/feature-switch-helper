export declare class FeatureDefDto {
    /**
     * 是否強制啟用功能
     *
...
export declare class FeatureSwitchConfigDto {
    /**
     * 功能開關的定義
     */
